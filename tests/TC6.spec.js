...
test('TC6', async () => {
    ...
    await page.locator('.suggestions-wrapper').isVisible();
    await page.locator('.suggest__title:has-text("ONE MAN SHOW")').click();
    await expect(page).toHaveURL('https://www.stream.cz/onemanshow');
