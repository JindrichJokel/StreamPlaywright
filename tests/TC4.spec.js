...
test('TC4', async () => {
   // await context.tracing.start({screenshots:true, snapshots: true}); 
    ...
    await page.locator('text=Načíst další videa').click();
    const count2 = page.locator('.search-episodes__item');
    const count1 = await count2.count();
    await expect(count1).toBeGreaterThan(100);
